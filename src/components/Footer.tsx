        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/pledge" className="text-sm text-primary-foreground/60 hover:text-accent transition-colors">The Network Pledge</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/intensive" className="text-sm text-primary-foreground/60 hover:text-accent transition-colors">The Intensive</Link></li>
