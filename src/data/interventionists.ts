...
export const interventionists: Interventionist[] = [
  {
    ...
    yearsExperience: 20,
    bio: "Founder of The Intervention Network and Freedom Interventions. 20+ years of frontline experience helping families navigate addiction crises.",
    fullBio: "Matt Brown has dedicated over two decades to helping families in crisis. As the founder of Freedom Interventions and The Intervention Network, he has personally conducted hundreds of interventions across the country. His approach combines the clinical rigor of evidence-based methods with the compassion that comes from his own 22 years of personal recovery.\n\nMatt is also the founder of the Sober Helpline and host of the Party Wreckers podcast, where he discusses the realities of addiction intervention with fellow professionals and families. His mission is simple: connect every family in crisis with a trusted professional who can help.\n\nBeyond his direct work with families, Matt has become a leading voice in the fight against patient brokering and referral fee culture in the addiction treatment industry. The Intervention Network was born from his belief that families deserve better — better access, better ethics, and better outcomes.",
