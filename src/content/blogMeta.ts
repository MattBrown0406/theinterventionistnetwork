// Generated by scripts/split-blog-posts.mjs — blog metadata index.
// Full post content lives in per-post modules under ./posts/, loaded on demand.
...
export const blogPostList: BlogPostMeta[] = [
  ...
  },
  {
    ...
    author: "Matt Brown",
    date: "2026-06-02",
    excerpt: "At some point in every interventionist's career, a family calls and the legal system is already involved. There's a pending DUI. A judge has ordered a substance abuse evaluation. Someone is threatening to file for involuntary commitment under the Marchman Act or an equivalent statute. The family is desperate, the stakes feel higher than usual, and they're asking you — the professional — what to do.",
    readTime: "8 min read",
  },
  {
    slug: "does-insurance-cover-addiction-treatment-family-guide",
    title: "Does Insurance Cover Addiction Treatment? A Family Guide to Navigating Coverage",
    author: "Matt Brown",
    date: "2026-05-25",
    excerpt: "When a family reaches the point of seeking help for a loved one's addiction, one of the first questions that comes up is almost always the same: \"Will insurance cover this?\" It's a fair question — and a critical one. The cost of addiction treatment can feel like another obstacle when you're already exhausted. The good news is that insurance coverage for addiction treatment has expanded significantly over the past decade, and most families have more options than they realize.",
    readTime: "7 min read",
  },
  {
    slug: "dual-diagnosis-addiction-family-guide",
    title: "Dual Diagnosis Explained: What Families Need to Know When Addiction and Mental Health Collide",
    author: "Matt Brown",
    date: "2026-05-20",
    excerpt: "You noticed the drinking long before you noticed the depression. Or maybe the anxiety came first — and then the pills. For many families watching a loved one struggle with addiction, there is a second layer underneath that is hard to name and even harder to understand.",
    readTime: "8 min read",
  },
  {
    slug: "talking-to-children-about-family-addiction",
    ...
    author: "Matt Brown",
    date: "2026-05-15",
    excerpt: "When a parent, sibling, or close family member is struggling with addiction, the children in that household already know something is wrong. They feel it in the tension at dinner, in the whispered conversations that stop when they walk into the room, in the unpredictability of the person they love. What they often lack are words — and permission to use them.",
    readTime: "13 min read",
  },
  {
    slug: "medication-assisted-treatment-modern-interventionist",
    title: "Medication-Assisted Treatment and the Modern Interventionist: What Every Practitioner Needs to Know",
    author: "Matt Brown",
    date: "2026-05-14",
    excerpt: "Medication-assisted treatment (MAT) has become one of the most evidence-supported tools in addiction medicine — and one of the most misunderstood topics in the intervention room. Families arrive with strong opinions. Clients arrive with fear or hope. And interventionists are often caught in the middle, expected to have an answer they may not have prepared for.",
    readTime: "9 min read",
  },
  {
    slug: "what-to-expect-in-early-recovery-family-guide",
    title: "What to Expect in Early Recovery: A Family Guide to the First 90 Days After Treatment",
    author: "Matt Brown",
    date: "2026-05-13",
    excerpt: "Your loved one just completed a 30-, 60-, or 90-day treatment program. You watched them walk through the hardest door of their life — and now they're home. Or almost home. And somewhere between relief and hope, a quiet fear surfaces: What do we do now?",
    readTime: "15 min read",
  },
  {
    slug: "clinical-boundaries-for-interventionists",
    title: "Holding the Line: Clinical Boundaries for Interventionists When Families Pull You In",
    author: "Matt Brown",
    date: "2026-05-12",
    excerpt: "You've been on the phone for four days with a mother who is terrified, exhausted, and convinced that if she doesn't reach you at 10 p.m., the whole thing will fall apart. You've answered. Every time. It made sense in the moment. But somewhere in that process, you stopped being her interventionist and started becoming part of her coping system — and that shift matters more than most of us are trained to recognize.",
    readTime: "9 min read",
  },
  {
    slug: "understanding-addiction-denial-in-loved-ones",
    title: "Why Your Loved One Can't See What You See: Understanding Addiction Denial",
    author: "Matt Brown",
    date: "2026-05-11",
    excerpt: "You've watched the problem grow for months — maybe years. The job losses, the broken promises, the 3 a.m. phone calls, the empty bottles you find and quietly throw away. You've had \"the conversation\" more times than you can count. And every time, you hear some version of the same thing: \"I'm fine. You're overreacting. I can stop whenever I want.\"",
    readTime: "11 min read",
  },
  {
    slug: "when-to-hire-a-professional-interventionist",
    title: "When DIY Isn't Enough: How to Know It's Time to Hire a Professional Interventionist",
    author: "Matt Brown",
    date: "2026-05-08",
    excerpt: "You've had the hard conversation. Probably more than once. You've set limits that disappeared the moment things got emotional. You've researched treatment centers at 2 a.m., left articles on the coffee table, and asked other family members to help. And still — nothing has changed.",
    readTime: "10 min read",
  },
  {
    slug: "what-to-say-to-loved-one-struggling-with-addiction",
    title: "What to Say (and What Not to Say) to a Loved One Struggling with Addiction",
    author: "Matt Brown",
    date: "2026-05-06",
    excerpt: "You've rehearsed it a hundred times in your head. You've drafted it on a napkin, deleted the text, started over. You love this person — and you have no idea how to talk to them without making things worse.",
    readTime: "12 min read",
  },
  {
    slug: "intervention-for-spouse-with-addiction",
    title: "When It's Your Partner: What Families Need to Know Before Staging an Intervention for a Spouse",
    author: "Matt Brown",
    date: "2026-05-04",
    excerpt: "Discovering that your spouse or life partner is struggling with addiction is one of the most disorienting experiences a person can face. The person you've built a life with — shared finances, children, a home, a future — is now at the center of a crisis that touches everything at once.",
    readTime: "10 min read",
  },
  {
    slug: "getting-your-family-on-the-same-page-before-intervention",
    title: "Getting Your Family on the Same Page Before an Intervention",
    author: "Matt Brown",
    date: "2026-05-01",
    excerpt: "The moment a family decides an intervention might be necessary is rarely a moment of calm agreement. More often, it looks like this: one person has been watching the situation deteriorate for months, finally ready to act — while a sibling is in denial, a spouse is terrified of conflict, and a parent quietly wonders if they're overreacting.",
    readTime: "10 min read",
  },
  {
    slug: "neuroscience-of-addiction-for-interventionists",
    title: "The Neuroscience of Compulsion: What Every Interventionist Should Know — and Be Able to Explain",
    author: "Matt Brown",
    date: "2026-04-30",
    excerpt: "One of the most powerful moments in an intervention isn't a letter being read or a loved one agreeing to go to treatment. It's the moment a family stops blaming themselves — or stops blaming the person they love — long enough to actually hear what's possible.",
    readTime: "10 min read",
  },
  {
    slug: "hidden-cost-of-waiting-why-families-delay-intervention",
    title: "The Hidden Cost of Waiting: Why Families Delay Intervention (And What It Really Costs)",
    author: "Matt Brown",
    date: "2026-04-29",
    excerpt: "If you're reading this, you've probably already been waiting. Maybe for months. Maybe for years.",
    readTime: "11 min read",
  },
  {
    slug: "how-to-write-an-intervention-letter",
    title: "How to Write an Intervention Letter That Actually Reaches Your Loved One",
    author: "Matt Brown",
    date: "2026-04-24",
    excerpt: "One of the most powerful tools in a planned intervention is the letter — and one of the most misunderstood. Families preparing for an intervention are often told to write one, but rarely given clear guidance on how to write an intervention letter that opens a door rather than slamming one shut.",
    readTime: "11 min read",
  },
  {
    ...
    author: "Matt Brown",
    date: "2026-04-16",
    excerpt: "One of the most consequential moments in the intervention process doesn't happen on the day of the intervention itself. It happens before you ever agree to take the case. A rigorous pre-engagement assessment for interventionists isn't a formality — it's the foundation on which everything else is built.",
    readTime: "10 min read",
  },
  {
  ...
  },
  {
    ...
    author: "Matt Brown",
    date: "2026-04-08",
    excerpt: "If you've been searching for a professional interventionist, you've probably come across terms like the Johnson Model, ARISE, or CRAFT — and wondered what any of it means. More importantly, you may be wondering which intervention model is right for your family and your loved one.",
    readTime: "10 min read",
  },
  {
    ...
    author: "Matt Brown",
    date: "2026-04-07",
    excerpt: "Grief in families of addicted loved ones is one of the most underrecognized dynamics in intervention work. By the time a family calls for professional help, they are rarely in acute crisis for the first time. Most have been quietly grieving for years — mourning the person they knew before the addiction took hold, the relationship they thought they had, the future they expected.",
    readTime: "10 min read",
  },
  {
    ...
    author: "Matt Brown",
    date: "2026-03-31",
    excerpt: "When a family contacts you about a loved one's addiction, they bring more than a problem. They bring a system — a complex web of roles, rules, loyalties, secrets, and survival strategies built over years or decades. Understanding family systems in crisis is not a theoretical exercise. It is the core clinical skill that separates interventionists who consistently achieve lasting outcomes from those who get compliance without commitment.",
    readTime: "10 min read",
  },
  {
    ...
    author: "Matt Brown",
    date: "2026-03-30",
    excerpt: "If you're searching for help with a loved one's addiction, one of the first questions you're likely asking is: how much does an intervention cost? It's a fair and practical question — and it's one that deserves a straight answer.",
    readTime: "9 min read",
  },
  {
  ...
  },
  {
    ...
    author: "Matt Brown",
    date: "2024-03-01",
    excerpt: "When a family calls a helpline or treatment referral service, they often believe they're getting unbiased guidance. The reality is far different. Most referral services in the addiction treatment industry operate on a commission model — they receive a fee for every client they send to a treatment center. These fees can range from $1,000 to $50,000 per placement.",
    readTime: "5 min read",
  },
];

const postModules = import.meta.glob<{ default: BlogPostEntry }>("./posts/*.ts");

export function loadBlogPost(slug: string): Promise<BlogPostEntry> | null {
