            ...
            <div className="bg-card border border-border rounded-lg p-6 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input value={form.credentials} onChange={(e) => setForm({ ...form, credentials: e.target.value })} placeholder="BRI-II, CADC" />
                </div>
                <div>
                  <Label>Region</Label>
              ...
              <div className="mt-4">
                ...
                <Input
                  ...
                  placeholder="BRI-II Certified, CADC, ARISE Trained"
                />
              </div>
