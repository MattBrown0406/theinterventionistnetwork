...
import { interventionists, specialtyOptions, stateOptions } from "@/data/interventionists";
...
const FindPage = () => {
  ...
  const filtered = useMemo(() => {
    return interventionists.filter((i) => {
      if (stateFilter && !i.statesServed.includes(stateFilter) && !i.statesServed.includes("National")) return false;
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              ...
              >
                ...
                {stateOptions.filter(s => s !== "National").map((s) => (
            ...
            <div className="flex items-end">
              <Button
                variant="outline"
                size="default"
                onClick={() => { setStateFilter(""); setSpecialtyFilter(""); setUrgencyFilter(""); }}
              >
                Clear
              </Button>
            </div>
          ...
          {filtered.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                Tell us about your situation and we'll personally connect you with a vetted interventionist.
              </p>
              <Button variant="gold" asChild>
                <Link to="/help">Tell Us Your Situation</Link>
              </Button>
            </div>
          )}
        </div>
