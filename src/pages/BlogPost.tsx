...
const blogContent: Record<string, { title: string; author: string; date: string; content: string[] }> = {
  "why-we-dont-charge-referral-fees": {
    ...
    content: [
      ...
      "We believe this is how the entire industry should work. Until it does, The Intervention Network will continue to operate by a different standard — one that puts families first, every single time.",
